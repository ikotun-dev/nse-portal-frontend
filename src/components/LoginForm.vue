      ...
      <div class="flex justify-center pt-3 lg:pt-12 pb-72 " v-show="showLogin">
        ...
        <div class="bg-white p-2">
          <div class="flex flex-col px-4 py-4 items-center w-86 lg:w-100 h-96 pt-14 border border-orange-900">
            ...
            <h3 class="text-red-800 font-pop" v-show="wrongCredentials">Wrong Credentials!</h3>
            <div
            ...
            <div
              ...
              <input class="px-2 py-2 h-8 w-40 rounded-sm focus:outline-none text-xs focus:ring-10 font-pop border-0"
                :type="inputType" placeholder="password : " v-model="password" required />
              <i class="mt-2 mr-2 text-green-800" :class="showPassword" @click="togglePasswordVisibility"></i>
            </div>
            <button
