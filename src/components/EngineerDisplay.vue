<template>
    <div class="mx-0 lg:mx-2 mt-2 pt-3 lg:pt-3 w-99  lg:w-70 h-24 py-1 sm:border-b-2 rounded-none lg:border-2 flex lg:rounded-sm lg:border-orange-950 hover:bg-gray-100">
